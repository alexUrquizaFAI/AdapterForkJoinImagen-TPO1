...
public class FiltroImagen extends RecursiveAction {
    //Varibles privades que no se podran modificar durante la ejecucion y por eso seran fianl
    //Para todas los objetos que instanciemos el UMBRAL sera el mismo y por eso sera static
