    ...
    public static void main(String[] args) throws Exception {
        ...
        if (extension.equals("jpg") || extension.equals("png")) {
         ...
         if (seguir && buffer != null) { // También añadí una protección extra aquí verificando != null
            ...
            //Se debe de ingresar la ubicacion exacta de la imagen seguido de "\nombreDeLaImagen.formato"
            //Ejemplo: C:\...\...\...\VS Code\LP\Proyecto 0\gatitos.pgm
            System.out.println("Ingrese el filtro que desea aplicar: ");
            System.out.print("[1] Invertir colores | [2] Escala de grises | [3] Subir brillo (40 unidades) [");
